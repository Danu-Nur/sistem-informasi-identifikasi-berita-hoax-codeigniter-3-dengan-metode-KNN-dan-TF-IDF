    ...
    <div class="container-fluid overcover">
        <div class="card card-warning card-outline container profile-box bg-dark">
            
            <div class="home row my-3">
                <div class="image-box bg-white">
                ...
                <div class="col-md-8 detail-col">
					...
					<a class="btn btn-small btn-light" data-toggle="modal" data-target="#editdata<?= $this->session->userdata('ID_USER') ?>"><i class="fas fa-edit"></i> Edit </a>

					<button class="btn my-2 bg-light">
								...
								<?php foreach($prof1 as $p): ?>
                                    <table class="addrss-list  table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th class="table-light text-dark">Username</th>
                                                <td>
												<?php echo $p->USRNAMA?>
												</td>
                                            </tr>
                                            <tr>
                                                <th class="table-light text-dark">Password</th>
                                                <td>
												<?php echo $p->PASWORD?>
												</td>
                                            </tr>
